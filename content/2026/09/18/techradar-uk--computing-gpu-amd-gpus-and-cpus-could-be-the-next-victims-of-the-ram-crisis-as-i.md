---
title: AMD may be planning a 'price adjustment' of its GPUs and CPUs soon — industry
  insider chatter says there could be a 10% rise, in the latest blow from the RAM
  crisis
source_url: https://www.techradar.com/computing/gpu/amd-gpus-and-cpus-could-be-the-next-victims-of-the-ram-crisis-as-industry-chatter-insists-more-price-hikes-are-coming
...
- **AMD is rumored to be hiking prices for its chips**
...
That means everything, so on the consumer front, we can expect AMD's GPUs and Ryzen processors to be hit with price increases — and motherboard chipsets are also affected, so the price of those AMD boards will climb, too.
