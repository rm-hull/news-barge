---
title: iOS 27, Siri AI, and iPadOS 27 compatibility explained — here's which devices
  are supported
source_url: https://www.techradar.com/phones/ios/ios-27-and-siri-ai-compatibility-explained
...
iOS 27 is now rolling out to compatible iPhones, and this year, the list of models supported by Apple's new software update is impressively long.
...
Alas, the device requirements for Apple Intelligence and Siri AI aren't so straightforward, so in this guide, we've detailed the support list for iOS 27, Apple Intelligence, Siri AI, and iPadOS 27.

### iOS 27

 ![iphone 11](https://cdn.mos.cms.futurecdn.net/QVZhRDWontbFNHxqERJe6.jpg) 
...
It’s worth noting, however, that even though older models like the iPhone 11, iPhone 12, and iPhone 13 support iOS 27, **Apple Intelligence — which includes features like Clean Up, Live Translation, and Apple's new AI-powered voice assistant, Siri AI — remains locked to theiPhone 15 Proand newer**.

### Siri AI

 ![Siri AI Demos](https://cdn.mos.cms.futurecdn.net/ihKYauAakuGN2f98SGZgdS.jpg) 
...
Importantly, though, not all Siri AI features will be available on those iPhones, iPads, and MacBooks.
 ...
 ![The Siri voice customization UI in Siri AI](https://cdn.mos.cms.futurecdn.net/92cvGQ46sgozAwozbGeXyV.jpg) 


Specifically, **expressive voices and advanced dictationare limited to devices powered by Apple’s "most powerful on-device model," AFM Core Advanced**. Those devices are as follows:
...
Interestingly, though, **EU userscanaccess Siri AI on macOS 27 and visionOS 27**.
...
### iPadOS 27
 ...
 ![Siri AI Demos](https://cdn.mos.cms.futurecdn.net/ieNPLeH8VRHVNFAYw7LprV.jpg) 
