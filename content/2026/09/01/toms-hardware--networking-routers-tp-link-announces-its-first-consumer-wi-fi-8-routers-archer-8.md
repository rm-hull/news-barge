---
title: TP-Link announces its first consumer Wi-Fi 8 routers — Archer 8 Ultra preorder
  commences September 30, in select regions
source_url: https://www.tomshardware.com/networking/routers/tp-link-announces-its-first-consumer-wi-fi-8-routers-archer-8-ultra-preorder-commences-september-30-in-select-regions
source_site: Tom's Hardware
source_slug: toms-hardware
scraped_at: '2026-09-01T04:59:14Z'
...
Earlier this year, TP-Link announced its intentions to launch the first members of its __Wi-Fi 8 (802.11bn) networking family__. At the time, the company revealed that it would first launch a standalone Archer 8 consumer router this fall, followed by a Deco 8 mesh router. And right on cue, TP-Link stated today that the Archer 8 Ultra BN19000 tri-band router will launch on September 30.
...
Wi-Fi 8 is shaping up to be more of a quality-of-life improvement over Wi-Fi 7 than a substantial theoretical speed improvement. Put simply, Wi-Fi 8 hardware devices should be able to come closer to __fulfilling the real-world performance metrics__ that Wi-Fi 7 devices originally promised.
...
What remains unclear is how or when these new Wi-Fi 8 products will launch in the U.S. As of today, TP-Link has yet to obtain FCC approval to release all-new products in the country. Unlike competitors __Amazon__ and __Netgear__, which received conditional approval from the FCC Covered List, the __U.S. government is still playing hardball with TP-Link__. For its part, TP-Link only says that preorders for the Archer 8 Ultra will open in “select regions” on September 30.
