---
title: This Spotify listener used Prompted Playlists in a '3D chess move' to preview
  their Wrapped — I tried it, it works, but I don’t think you should do it
source_url: https://www.techradar.com/audio/spotify/someone-used-this-spotify-tool-to-cheat-and-preview-their-wrapped-2026-summary-and-i-tried-it-out-and-it-works-but-theres-no-way-id-do-it-again
source_site: TechRadar UK
source_slug: techradar-uk
scraped_at: '2026-09-21T20:26:21Z'
published: '2026-09-21T00:00:00Z'
description: With Spotify's Prompted Playlists you can get a sneak preview of what
  your Wrapped could look like.
categories:
- Technology & Software
- Music
...
Spotify Wrapped is roughly two to three months away (I know, I almost threw up in my mouth just at the thought of it), but not only does it show how fast the year flies by, but it also keeps you guessing which artists and songs will come out on top.
...
It was almost too good to be true, but after refreshing the playlist and amending the prompt, the order of the songs in the playlist stayed the same, with each update showing that it does have some credibility. Though I respect the tool for its intelligence, I can’t say I’ll be using it much from now on.

## Does no one enjoy surprises any more?

![Two iPhones with a Prompted Playlist in the Spotify app](https://cdn.mos.cms.futurecdn.net/qr4AgscfvjwZPfDiYe8Z37.jpg)
