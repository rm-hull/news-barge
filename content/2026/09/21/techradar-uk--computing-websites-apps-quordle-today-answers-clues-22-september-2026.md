---
title: 'Quordle hints and answers for Tuesday, September 22 (game #1702)'
source_url: https://www.techradar.com/computing/websites-apps/quordle-today-answers-clues-22-september-2026
...
## Quordle today (game #1702) — hint #1 — Vowels
...
## Quordle today (game #1702) — hint #2 — repeated letters

### Do any of today's Quordle answers contain repeated letters?

**•** The number of Quordle answers containing a repeated letter today is**2**.

## Quordle today (game #1702) — hint #3 — uncommon letters

### Do the letters Q, Z, X or J appear in Quordle today?

**• No**. None of Q, Z, X or J appear among today's Quordle answers.

## Quordle today (game #1702) — hint #4 — starting letters (1)
...
## Quordle today (game #1702) — hint #5 — starting letters (2)
...
![Quordle answers for game 1702 on a yellow background](https://cdn.mos.cms.futurecdn.net/ay5GqcLJKDwtmXAtLY87vb.png)
...
![Quordle Daily Sequence answers for game 1702 on a yellow background](https://cdn.mos.cms.futurecdn.net/zh6mzZqtixcYt7L74Lm3wb.png)
