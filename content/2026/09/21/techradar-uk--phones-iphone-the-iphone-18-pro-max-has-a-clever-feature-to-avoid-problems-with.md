---
title: The iPhone 18 Pro Max uses a clever battery trick to get around capacity restrictions
  — and you’ll need to know about it if you ever plan to sell yours
source_url: https://www.techradar.com/phones/iphone/the-iphone-18-pro-max-has-a-clever-feature-to-avoid-problems-with-its-larger-battery-that-might-become-the-new-normal-heres-what-you-need-to-know
source_site: TechRadar UK
source_slug: techradar-uk
scraped_at: '2026-09-21T20:25:35Z'
published: '2026-09-21T00:00:00Z'
description: The iPhone 18 Pro Max's battery is too high capacity for standard shipping,
  but Apple has found a software solution.
categories:
- Technology & Software
...
This is a mode that uses battery firmware to limit the capacity to under 20Wh, and it's active from when the phone is manufactured to when a customer first activates it.
...
![The &#039;Prepare to Ship&#039; option on an iPhone 18 Pro Max](https://cdn.mos.cms.futurecdn.net/4p8Vx3C7fBxpSjPiiCSngn.jpg)
...
There are a few things to be aware of though: to activate ‘Prepare to Ship’ mode, your phone might need to discharge a bit, so you should unplug it from its charger, and you should also be aware that it might become warmer than usual while this process is being carried out.
