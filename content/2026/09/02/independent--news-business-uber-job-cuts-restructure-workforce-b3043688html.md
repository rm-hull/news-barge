---
title: Uber to cut more than 3,000 jobs as part of a major restructuring
source_url: https://www.independent.co.uk/news/business/uber-job-cuts-restructure-workforce-b3043688.html
source_site: The Independent
source_slug: independent
scraped_at: '2026-09-02T19:22:58Z'
published: '2026-09-02T00:00:00Z'
description: The boss of the US-based ride-hailing app told staff that the changes
...
In a corporate message sent to staff members on Wednesday, chief executive Dara Khosrowshahi explained that eliminating layers of management and merging operational teams would help to create a "simpler and faster" business.

The US-based ride-hailing app, which has its global head office in San Francisco, did not outline precisely how many corporate positions would be affected in each location where it operates, including its UK office based in London.

While affected employees have already been notified of the decision, the firm noted that staff in some countries will have to follow specific local processes.

The shake-up, which will ultimately reduce the size of the company's overall workforce by about 10 per cent, was first reported by *Bloomberg*.
...
The rollout, planned for this year, is expected to be delayed due to a lack of permit approval by the Driver and Vehicle Standards Agency (DVSA) and operational guidelines from Transport for London (TfL).
