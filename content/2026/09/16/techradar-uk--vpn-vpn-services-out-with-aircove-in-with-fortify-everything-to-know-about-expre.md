---
title: 'Out with Aircove, in with Fortify: everything to know about ExpressVPN''s
  new router'
source_url: https://www.techradar.com/vpn/vpn-services/out-with-aircove-in-with-fortify-everything-to-know-about-expressvpns-new-router
...
- **ExpressVPN has replaced its Aircove router with Fortify, a faster Wi-Fi 6 model built on GL.iNet's Flint 2 platform**
...
![ExpressVPN — best for beginners ExpressVPN — best for beginners](https://cdn.mos.cms.futurecdn.net/NNfAW8AyUh9MJiVKAtYBCF-200-80.jpg.webp)
...
## How Fortify works, and what's included
...
On trust, ExpressVPN points to its no-logs policy and RAM-only TrustedServer infrastructure, independently audited by firms including PwC, Cure53 and KPMG. Aircove also __passed a Cure53 security audit__ at launch.

Fortify goes on sale from GL.iNet's website on September 16 at an MSRP of $199.99.

 ![Table comparing ExpressVPN Aircover and Fortify features](https://cdn.mos.cms.futurecdn.net/cmHnEsi4ZPuXkZ3wBfe9zR.png) 
