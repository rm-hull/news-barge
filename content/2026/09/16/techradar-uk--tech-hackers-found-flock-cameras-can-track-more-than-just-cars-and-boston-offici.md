---
title: Hackers just extracted a scary amount of data from a downed flock camera, as
  Boston reveals it won’t use Flock anymore over data sharing concerns
source_url: https://www.techradar.com/tech/hackers-found-flock-cameras-can-track-more-than-just-cars-and-boston-officials-found-camera-data-was-shared-despite-being-told-it-wouldnt-be
source_site: TechRadar UK
source_slug: techradar-uk
scraped_at: '2026-09-16T22:53:46Z'
published: '2026-09-16T00:00:00Z'
description: Is there a right way to use ALPR?
...
- **Boston officials released a report explaining why they won't use Flock cameras**
...
Limiting automatic sharing of data to other agencies and restricting the police officers with access are a good starting point. They also argue that all Flock data requests should require case numbers to be attached, and for officers to provide a reason for each request.
