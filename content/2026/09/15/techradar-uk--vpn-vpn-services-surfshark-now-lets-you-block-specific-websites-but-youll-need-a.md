---
title: Surfshark now lets you block specific websites — but you'll need a Windows
  PC
source_url: https://www.techradar.com/vpn/vpn-services/surfshark-now-lets-you-block-specific-websites-but-youll-need-a-windows-pc
...
- **Surfshark has added an allowed websites list to its web content blocker** 
...
## How to use the allowed websites list
...
2. Click the **Settings** cogwheel icon in the left navigation menu.
3. Navigate to **Web content blocker** .
4. Scroll down and click on **Allowed websites** .
5. Press **Add** .
6. Enter the specific website URLs you want to allow.
