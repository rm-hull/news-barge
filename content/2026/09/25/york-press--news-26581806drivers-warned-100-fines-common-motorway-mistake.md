---
title: UK drivers warned of £100 fines over common motorway mistake
source_url: https://www.yorkpress.co.uk/news/26581806.drivers-warned-100-fines-common-motorway-mistake/
source_site: York Press
source_slug: york-press
scraped_at: '2026-09-25T13:39:46Z'
published: '2026-09-25T00:00:00Z'
description: Red X signs are used to close lanes in the event of an obstruction, and
  ignoring them can result in a fine of up to £100 and three penalty points.
categories:
- Local
- York
- Automotive
...
Thousands of motorway drivers risk a £100 fine and three penalty points by ignoring red X signs.

Red X signs are used to close lanes in the event of an obstruction, and ignoring them can result in a fine of up to £100 and three penalty points.

Nicholas Lyes, director of policy and standards at IAM RoadSmart, said: "Ignoring a red X sign on a smart motorway is dangerous because it risks a serious collision and, for this reason, we welcome police forces clamping down on those who break the law.
...
National Highways staff activate the red X signs when a stopped vehicle is detected in a live lane, to prevent collisions and protect emergency responders.

Mr Lyes added: "We know that no new all-lane running smart motorways will be built but it does beg the question of what we do with the existing stretches that are in operation?

"This is something the new Government needs to give some serious thought to."

## What can fail an MOT test?

A spokesperson for National Highways said: "A Red X signal is there to increase the safety of everyone using the road by highlighting an issue ahead.
