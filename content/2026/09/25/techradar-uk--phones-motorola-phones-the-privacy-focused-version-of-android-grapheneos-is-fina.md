---
title: GrapheneOS is finally coming to a non-Pixel phone — and it’s a handset that
  could compete with the best Android devices
source_url: https://www.techradar.com/phones/motorola-phones/the-privacy-focused-version-of-android-grapheneos-is-finally-coming-to-a-phone-that-isnt-a-google-pixel
source_site: TechRadar UK
source_slug: techradar-uk
scraped_at: '2026-09-25T13:40:48Z'
published: '2026-09-25T00:00:00Z'
description: The Motorola Signature 27 is set to support GrapheneOS, so you won't
  have to buy a Pixel to de-Google your Android phone.
categories:
- Technology & Software
...
* **GrapheneOS will work with the Motorola Signature 27**
...
But unlike most of those rivals, you’ll be able to install GrapheneOS on it, as confirmed by the GrapheneOS X account. In fact, you might not even need to install it, as versions of the handset that ship with GrapheneOS pre-installed in place of Android are apparently planned too.
...
![GrapheneOS App Store showing on Pixel 8 Pro](https://cdn.mos.cms.futurecdn.net/vhUmUHrSAhTM6A53E76rp8.jpg)
...
So in other words it sounds like the use of this new chipset, alongside long-term software support, is why the operating system is being brought to the Motorola Signature 27 specifically.
