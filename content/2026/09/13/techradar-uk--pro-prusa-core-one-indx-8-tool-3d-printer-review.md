---
title: Prusa's CORE One+ INDX 8-Tool 3D printer changed how I think about printing
source_url: https://www.techradar.com/pro/prusa-core-one-indx-8-tool-3d-printer-review
source_site: TechRadar UK
source_slug: techradar-uk
scraped_at: '2026-09-13T18:46:05Z'
...
Prusa is at the heart of the open-source 3D printing community, and this machine really shows it, as its partnership with Bondtech has produced one of the finest machines on the market today.
...
Whilst that's machine is only one filament, upgrading that reliable system into this eight-tool-changer machine absolutely makes sense.
...
## Prusa CORE One+ (Gen 2) INDX 8-Tool: Design
 ...
 ![Prusa CORE One+ (Gen 2) INDX 8-Tool](https://cdn.mos.cms.futurecdn.net/sBXZhFDFsm9ivoTVmJfRzM.jpg) 
...
This added dock essentially covers the view to the platform and contains the eight new toolheads, which are all heated through induction rather than traditional wires. This means that they can be attached to their magnetic dock along the front of the machine cold, heated up in just a few seconds, and printing following a filament change can start within a few seconds, far faster than any other system.
 ...
 ![Prusa CORE One+ (Gen 2) INDX 8-Tool](https://cdn.mos.cms.futurecdn.net/xGpBf3pnCmnDjoGf4eAi2N.jpg) 
...
## Prusa CORE One+ (Gen 2) INDX 8-Tool: Features
 ...
 ![Prusa CORE One+ (Gen 2) INDX 8-Tool](https://cdn.mos.cms.futurecdn.net/RaDK3R9oPvpwM5Ehy7dePM.jpg) 


 ![Prusa CORE One+ (Gen 2) INDX 8-Tool](https://cdn.mos.cms.futurecdn.net/96BeQXHXC7Njfd3jJbvuzM.jpg) 
...
## Prusa CORE One+ (Gen 2) INDX 8-Tool: Performance
 ...
 ![Prusa CORE One+ (Gen 2) INDX 8-Tool](https://cdn.mos.cms.futurecdn.net/ghyXbxwCVtnmkbrxckKqzM.jpg) 
...
Add the totals for a final score of 27 out of 30.
 ...
 ![Prusa CORE One+ (Gen 2) INDX 8-Tool](https://cdn.mos.cms.futurecdn.net/afntqDML4gFvqiTpZWgFKM.jpg) 
...
## Original PRUSA CORE One: Final verdict
 ...
 ![Prusa CORE One+ (Gen 2) INDX 8-Tool](https://cdn.mos.cms.futurecdn.net/cZPjYSuz5vVtGmJPRf2CbM.jpg) 
...
| Value: | Excellent value for 8-tool printing, giving reliability, speed and repairability when you need it | 5 | 
| Design: | Robust and practical design, although spool handling and bed size are a compromise. | 4.5 | 
| Features: | The 8 tools, color mixing, offline operation and essential easy maintenance make this a great business option. | 5 | 
| Performance: | Fast and reliable multicolor printing with excellent quality after initial bedding in an calibration. | 5 | 
| Total: | A superb multitool printer that combines speed, flexibility and reliability. | 5 | 
