---
title: Bernie Sanders proposes 20 year prison sentence for AI devs who plow ahead
  with Artificial Superintelligence plans — penalty on par with illegally developing
  rogue nuclear weapons
source_url: https://www.tomshardware.com/tech-industry/artificial-intelligence/sanders-proposes-20-year-prison-sentence-for-ai-devs-who-plow-ahead-with-artificial-superintelligence-plans-penalty-on-par-with-illegally-developing-rogue-nuclear-weapons
source_site: Tom's Hardware
source_slug: toms-hardware
scraped_at: '2026-09-13T18:46:53Z'
...
Senators Bernie Sanders and Greg Cezar have announced their Ban Artificial Superintelligence Act. Seeking to pause advanced AI development, the legislation’s stick is pretty severe. Penalties facing entities/developers who violate the pauses and prohibitions in the bill could face up to 20 years in prison. That’s a sentence on a par with someone found guilty of designing a rogue nuclear weapon.
 ...
 ![Ban Artificial Superintelligence Act wording on penalties](https://cdn.mos.cms.futurecdn.net/tAXcG6gcsh2msMLWNe39rd.jpg) 
...
- 
Reply
Not saying Sanders is 100% correct, but maybe the world should come to some sort of agreement, like what happened with nuclear weapons.pjmelect said:It annoys me when I see comments like this as if the USA is the whole world, while a ban maybe implemented in America the rest of the world will take no notice.
- 
You don't need advanced technology for this. You can already build and tweak AI models at home. Totally different than nukes. These restrictions are reckless panic and show he is ignorant on what we actually are dealing with.Reply
...
- 
Reply
 And these local models get their data from...where?MrK26 said:You don't need advanced technology for this. You can already build and tweak AI models at home. Totally different than nukes. These restrictions are reckless panic and show he is ignorant on what we actually are dealing with.
...
- 
Reply
 Cool.MrK26 said:New local models don't need giant datacenters, they run just fine at home and there are already ones that'll tell you anything you want, no guardrails at all. It's already done, people know, just not obvious to the mainstream yet.
So we can now dispense with all these companies building these big DC's?
- 
ReplyUSAFRet said:Not saying Sanders is 100% correct, but maybe the world should come to some sort of agreement, like what happened with nuclear weapons.
...
- 
ReplyUSAFRet said:And these local models get their data from...where?
 ...
 E.g., here's a qwen3.8 model (about as good as Anthropic's Opus 4.6) and you can run without an internet connection: [https://huggingface.co/huihui-ai/Huihui-Qwen3.8-27B-abliterated](https://huggingface.co/huihui-ai/Huihui-Qwen3.8-27B-abliterated)
...
- 
Reply
 I completely get what you're saying.MrK26 said:The model IS the data.
