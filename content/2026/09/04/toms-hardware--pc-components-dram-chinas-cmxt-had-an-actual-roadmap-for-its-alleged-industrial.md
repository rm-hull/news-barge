---
title: Chinese chipmaker CXMT allegedly used a written roadmap to steal Samsung DRAM
  tech — South Korean court says 'Project Hefei' lifted 620-step recipe to build 10%
  global market share
source_url: https://www.tomshardware.com/pc-components/dram/chinas-cmxt-had-an-actual-roadmap-for-its-alleged-industrial-espionage-from-samsung-south-korean-court-says-project-hefei-was-responsible-for-cxmts-current-position-as-major-dram-maker
...
- 
I'll buy CXMT ram a month after hell freezes over. Chinese firms like this have stolen trillions of dollars of IP from abroad, with the full and complicit assistance of the CCP government: a brutal authoritarian regime that keeps three million of its own citizens in slave-labor genocide camps, and employs an army of two million state agents to censor what the rest of its citizens can read and post to the Internet.Reply
