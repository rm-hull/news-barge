---
title: I tested the Bambu Lab R1 — it makes laser engraving surprisingly easy
source_url: https://www.techradar.com/pro/bambu-lab-r1-laser-cutter-and-engraver-review
source_site: TechRadar UK
source_slug: techradar-uk
scraped_at: '2026-09-22T19:44:19Z'
published: '2026-09-22T00:00:00Z'
description: Bambu Lab enters the dedicated laser market with a powerful 55W CO2 laser
  cutter, featuring superb positioning, automatic alignment, and outstanding results.
categories:
- Technology & Software
...
The Bambu Lab R1 is an exceptional 55W CO2 laser cutter with superb cutting and engraving across a wide range of materials. However, it’s the versatility and ease of use with the software that enable the hardware to adapt accurately to materials being placed within. While Basswood Ply results are notably good, it was the flat sheet acrylic and engraving onto curved objects that really showed how good this machine is, even if a little more polish needs to be applied to the software.
...
While there are plenty of machines in the sector, this is Bambu Lab, and with their first laser, they also bring much of the knowledge of 3D printing with them, along with their own approach to automation.
...
![Bambu Lab R1](https://cdn.mos.cms.futurecdn.net/z7T476V6JxFbxC6VBAekdE.jpg)
...
**Laser technology:** 55W CO2**Working area:** 600 x 300mm**Working area with Conveyor:** 600 x 3000mm**Maximum speed:** 1,000mm/s**Maximum acceleration:** 20,000mm/s²**Positioning accuracy:**< 0.2 mm** Absolute motion accuracy:**< 0.1 mm across 600mm with Vision Encoder** Dimensions:**940 x 560 x 200mm** Weight:**33.5kg** Maximum input power:**780W** Software:**Bambu Suite** Supported OS:**Windows, macOS** Connectivity:**Dual-band Wi-Fi, USB** Laser safety:**Class 1 in standard enclosed configuration** Short-focus spot:**0.11mm** Medium-focus spot:**0.17mm** Long-focus spot:**0.19mm** Maximum cutting capacity:**18mm black walnut with medium/long-focus lens; 20mm acrylic.** Standard lens:**Short-focus** Supported cutting/engraving materials:**Wood, acrylic including clear acrylic, leather, fabric, paper, EVA foam and shell** Engraving materials:**Glass, ceramic and coated metal** Optional accessories:** Riser Base, Conveyor, Rotary, medium/long-focus lenses, Vision Encoder, E1 Pro Air Purifier and Auto Fire Extinguishing System.
...
![Bambu Lab R1](https://cdn.mos.cms.futurecdn.net/No4edfxcu5NySyvwBPaq2E.jpg)
...
![Bambu Lab R1](https://cdn.mos.cms.futurecdn.net/geSiC53D622GGF5vtEmVvF.jpg)
...
![Bambu Lab R1](https://cdn.mos.cms.futurecdn.net/NSuyuAJwDQES85dRJywX4D.jpg)
...
![Bambu Lab R1](https://cdn.mos.cms.futurecdn.net/nwHL79gZcc7p8MokymqjdD.jpg)
...
|  |  |  |
| --- | --- | --- |
| **Value:** | Premium price, but with serious production capability | 4 |
| **Design:** | Considering the size of the work area it's relatively compact and exceptionally solid | 4.5 |
| **Features** | Automation brought over from 3D printing makes complicated jobs simple. | 5 |
| **Performance** | Excellent cuts and detail with superb positioning and minimal scorching | 5 |
| **Total** | Exceptional CO2 cutter, software needs some workflow issue resolving. | 4.5 |
