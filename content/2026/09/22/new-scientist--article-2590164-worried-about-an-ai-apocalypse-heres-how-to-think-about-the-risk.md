---
title: Worried about an AI apocalypse? Here's how to think about the risk of doom
source_url: https://www.newscientist.com/article/2590164-worried-about-an-ai-apocalypse-heres-how-to-think-about-the-risk-of-doom/?utm_campaign=RSS|NSNS&utm_content=home&utm_medium=RSS&utm_source=NSNS
source_site: New Scientist
source_slug: new-scientist
scraped_at: '2026-09-22T13:23:23Z'
published: '2026-09-22T00:00:00Z'
description: Commentators say the probability of machines wiping us out ranges from
  0 to over 95 per cent. Columnist Jacob Aron explains why you shouldn't trust any
  of those numbers
categories:
- Science
- Technology & Software
...
First, as with any question of probability, we have to make some assumptions. I will assume you have actually bought a ticket and that you are playing the UK National Lottery. The odds of winning any prize, from a free play up to the jackpot, are about 1 in 4.9, or 20.4 per cent. That means your odds of losing are 79.6 per cent, which is how the lottery makes money – most players lose.

Let’s move to something more serious: what are your odds of dying in a road traffic collision? According to the World Health Organization, slightly more than 1 million people die in road traffic collisions each year, so the odds of this happening to you are around 1 million divided by 8 billion, or roughly 0.01 per cent.
...
According to the latest UN Environment Programme Emissions Gap Report, published last year, under current policies, there is a 100 per cent chance of exceeding 1.5°C of warming this century, a 92 per cent chance of exceeding 2°C and a 20 per cent chance of exceeding 3°C. These figures also come with error bars, but broadly give you a picture of where we are heading. On the strongest assumptions of climate action, the chances of exceeding 1.5°C, 2°C and 3°C fall to 79 per cent, 22 per cent and 0 per cent respectively. Clearly, these are actions worth taking.
...
Fortunately, these numbers are all very well quantified. As you might expect, larger asteroids are both easier to spot and more deadly. According to NASA, we have found more than 90 per cent of all asteroids above 1-kilometre wide (if you want to know how we can be sure, I explained the technique previously here).

What’s more, we are able to predict their future positions with high accuracy, so we know there is either no or an extremely low chance of one hitting Earth within the next century. Chicxulub, the asteroid that wiped out the dinosaurs, was about 10 kilometres wide, so the fact that we are essentially safe from anything an order of magnitude smaller and up is good news. The latest estimates suggest that an impact by an object 1 kilometre or larger only happens once every 600,000 years or so.
