---
title: '''Stark'' warnings prompt North Yorkshire MP to urge emergency AI summit'
source_url: https://www.yorkpress.co.uk/news/26572320.tom-gordon-mp-joins-calls-pm-host-emergency-ai-summit/
source_site: York Press
source_slug: york-press
scraped_at: '2026-09-22T19:45:10Z'
published: '2026-09-22T00:00:00Z'
description: Tom Gordon MP has joined calls for an emergency summit to fast-track
  AI regulation following what he described as “stark” warnings from industry…
categories:
- Local
- York
- Technology & Software
...
Tom Gordon MP has joined fellow MPs in urging the Prime Minister to take action to slow down and regulate the pace of advanced AI technology *(Image: PA)*
...
![]()"This technology isn't going to wait for Whitehall's usual timetable, and neither should we" *(Image: Supplied)*

Mr Gordon said: “Lib Dem colleagues are right to push for this, and I back them wholeheartedly.

“The government promised an AI Bill in the King's Speech back in 2024. We're still waiting.
...
They said: “These risks cross borders, so we are working closely with the companies developing the most advanced systems, and with our allies and international partners.
...
![]()The MPs have called on the Prime Minister to fast-track an AI Bill promised in the King's Speech in 2024 and convene an emergency AI summit in response to calls from AI leaders about the risks associated without regulation *(Image: Kirsty Wigglesworth)*
...
In response, a government spokesperson said: “We should not assume that the existing framework will always be sufficient as AI capabilities develop.
