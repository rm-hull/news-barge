---
title: Can't see your speed or traffic data on Google Maps in Android Auto? You're
  not alone — here's what we know about the issues
source_url: https://www.techradar.com/vehicle-tech/car-infotainment/the-google-maps-speedometer-has-started-disappearing-on-android-auto-and-some-users-are-also-missing-traffic-data
...
Other users say the bug is connected to switching to or from the beta versions of Android Auto and Google Maps, which could be another explanation of what's happening. For now though, Google hasn't officially acknowledged that there's an issue.
