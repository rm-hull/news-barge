...
description: Jacob Coxon talks to WIRED about the “mini Manhattan project” inside
...
If alignment goes badly, then we could have a catastrophic outcome in the next few years. Maybe it goes well and there's some sort of slow down agreement, but either way, it's gonna get decided in the next couple of years.
...
I think it's a really natural question to ask because, as I've said many times, this stuff sounds like science fiction. But the classic example is, like, synthesizing a new virus, or taking down critical infrastructure doing some sort of hacking spree—the latter might be less likely to kill literally everyone.
