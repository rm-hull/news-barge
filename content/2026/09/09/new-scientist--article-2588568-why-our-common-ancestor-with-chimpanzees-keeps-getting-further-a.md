---
title: Why our common ancestor with chimpanzees keeps getting further away | New Scientist
source_url: https://www.newscientist.com/article/2588568-why-our-common-ancestor-with-chimpanzees-keeps-getting-further-away/?utm_campaign=RSS|NSNS&utm_content=home&utm_medium=RSS&utm_source=NSNS
source_site: New Scientist
source_slug: new-scientist
scraped_at: '2026-09-09T22:29:54Z'
published: '2026-09-09T00:00:00Z'
description: The more we learn about chimpanzees, the more they resemble us – but
...
Chimpanzees, along with bonobos, are our closest living relatives. Of all the millions of other animals on Earth, they are the ones that are most like us. And the more we learn about chimpanzee behaviour, the more obvious the similarities become.

For instance, wild chimpanzees peer at each other: one chimpanzee will sit close to another and closely watch what they’re doing. Nora Slania at the Max Planck Institute of Animal Behavior in Germany and her colleagues found that, from a young age, chimps peer at others as they perform a range of tasks. This included complex tasks like making tools, but also supposedly simple things like feeding and grooming.
...
![](https://www.newscientist.com/wp-content/uploads/2026/09/SEI_311178948.jpg?w=840)
...
He and his colleagues began systematically compiling estimates of the human-chimp split, aided by a handy online database called TimeTree which compiles estimates of all such “species divergences”. Eventually they had 202 estimates, published from the late 1960s to the 2020s. Nobody else has systematically analysed the estimates in this way, says d’Oliveira Coelho (and I can’t recall seeing anything comparable).
...
Some of it is simply a matter of better data. We got the first draft of the chimpanzee genome in 2005. Everything before that was based on snippets of the genome, not the whole thing. Twenty years later, we got a much more complete version of the chimp genome, which filled in a lot of missing pieces and corrected many errors. Nowadays we also have a great many human genomes, meaning that we have a better sense of how much the DNA sequence varies.
...
In practice, it’s fiendish. Different parts of the genome evolve at different speeds. Genes involved in immunity change at a furious rate to keep up with new diseases, while genes involved in fundamental processes like making proteins barely change at all. Some species’ genomes change faster than others. Changes in population size matter. Changes in generation time – that is, the average age at which a species reproduces – also matter, and this can vary between males and females.
...
“There’s all these things you need to model, and they are not in straight lines,” says d’Oliveira Coelho.

However, one of the biggest factors in pushing the date of the split back is the gradual acceptance of key fossil finds. The oldest putative hominins have all been discovered in the 21st century. *Orrorin* and the oldest*Ardipithecus* were first described in 2001, with*Sahelanthropus* following in 2002. This pushed the fossil evidence of humanity way back, from around 4 million years ago to 7 million years ago.

In theory, this should have immediately pushed back genetic estimates. Geneticists can use well-dated fossils as “anchors” in their models: instead of guessing how long a particular branch of the family tree was, they can input a hard data point. But for a long time they didn’t.

“Even after the three oldest hominins, *Ardipithecus*,* Orrorin*and* Sahelanthropus,*were published, it took years and years and years for geneticists to include that,” says d’Oliveira Coelho.* Sahelanthropus* is about 7 million years old, but it wasn’t until around 2015 that the average estimate of the human-chimp split became older than this. D’Oliveira Coelho blames this on a lack of communication between physical anthropologists and geneticists, and on some geneticists being overconfident about their data and methods.
...
Yet the more we learn about chimpanzees, the more they look like us. A study published in March showed that, when chimpanzees play together, they can quickly mimic the expressions their playmates make when they laugh. This may make for smoother social interactions and more enjoyable play. A June study, by a different group of researchers, found that chimpanzees and other great apes laugh in ways that are remarkably similar to us. This was especially true of laughter elicited by tickling. The researchers argued that “great apes have been laughing in a recognizable way to modern humans for at least 15 million years”.
