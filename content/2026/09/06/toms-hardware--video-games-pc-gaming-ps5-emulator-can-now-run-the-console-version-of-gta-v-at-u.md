---
title: PS5 emulator can now run the console version of GTA V at up to 60 FPS on PC,
  but quickly crashes as tweakers continue to optimize — PS5 emulation advancing at
  an astronomical pace leading up to GTA VI launch
source_url: https://www.tomshardware.com/video-games/pc-gaming/ps5-emulator-can-now-run-the-console-version-of-gta-v-at-up-to-60-fps-on-pc-but-quickly-crashes-as-tweakers-continue-to-optimize-ps5-emulation-advancing-at-an-astronomical-pace-leading-up-to-gta-vi-launch
...
PS5 Version of Grand Theft Auto 5 emulated on KyTyPS5 emulator at 40 to 60 fps pic.twitter.com/JJlvqrHCofSeptember 5, 2026
...
More PlayStation 5 games are now running smoothly on Kyty PS5 Emulator.Current playable titles include:• Tomb Raider IV-VI Remastered• STORY OF SEASONS: A Wonderful Life• PAC-MAN WORLD Re-PAC• Double Dragon Gaiden: Rise of the DragonsAll of them are now rendering and… pic.twitter.com/Ms4RCS29muAugust 6, 2026
...
Grand Theft Auto PS5 version PPSA04264 running on PS5 emulator KyTyPS5 forks.(some of the builds are forks, some are local builds)(Yes, GTA 5 is on PC, we know that, the point is the progress for big 3D games).for updates: [https://t.co/Hz6VoBrtHh](https://t.co/Hz6VoBrtHh) credit to ihc160/Komary pic.twitter.com/en1iKatnmTSeptember 6, 2026
...
GTA V actually first booted inside KytyPS5 a week ago before getting to this point, but it's not the only game running well right now. There are at least four other PS5 titles capable of being played at 60 FPS through emulation. The tweet above shows them all running on an RTX 5080 system with a Ryzen 7 5800X3D. We tried one game ourselves — PAC-MAN WORLD Re-PAC — and it ran shockingly well, locked at 60 FPS, even on an RX 6700 XT rig paired with a Ryzen 7 7700X processor.
 ...
 ![The PS5 version of PAC-MAN WORLD Re-PAC being emulated on a PC via KytyPS5](https://cdn.mos.cms.futurecdn.net/UQT97vjE98fi2sgK37MpMj.png) 
...
SharpEmu is delivering a lot of achievements on the handheld side, though, with massive improvements made for the Steam Deck. The post below shows a similar level of performance for Astro’s Playroom compared to a much more powerful RX 7900 XT system with a Ryzen 9 7900X CPU. It's still barely 1 frame per second, and the game doesn't get past the boot screen, but the fact that it's even possible is enough cause for celebration. Remember, this is the worst that PS5 emulation will ever be.

SharpEmu just hit a pretty wild Steam Deck emulation milestone.-Astro’s Playroom booted locally on SteamOS-PS5 emulation running directly on Steam Deck-Roughly 0.5–1 FPS-Only reaches the intro/loading sequence-Completely unplayable right nowThe interesting part isn’t… pic.twitter.com/qL8lLKHwDOAugust 14, 2026
