---
title: '''This situation is obviously unacceptable'': OpenAI agent allegedly hacks
  Australian government healthcare website'
source_url: https://www.techradar.com/pro/security/this-situation-is-obviously-unacceptable-openai-agent-allegedly-hacks-australian-government-healthcare-website
source_site: TechRadar UK
source_slug: techradar-uk
scraped_at: '2026-09-24T13:31:22Z'
published: '2026-09-24T00:00:00Z'
description: OpenAI behavior is "unacceptable," Australian government says
categories:
- Technology & Software
- News & Politics
...
OpenAI was apparently evaluating its models, and investigating “misaligned model activity” when, on August 11, it discovered the breach in Australia. It seems the AI agent simply did not take “no” for an answer. The company then notified Services Australia on September 10 - almost three months after the incident. To make matters worse, the company reached out via [publicdisclosures@servicesaustralia.gov.au](mailto:publicdisclosures@servicesaustralia.gov.au), inbox researchers usually use to report potential vulnerabilities, instead of trying to escalate the incident higher.
