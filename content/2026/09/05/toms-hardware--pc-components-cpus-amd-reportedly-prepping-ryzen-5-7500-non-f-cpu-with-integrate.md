---
title: AMD reportedly prepping Ryzen 5 7500 (non-F) CPU with integrated graphics at
  double the price — Six-core Zen 4 chip rumored to share identical specs with its
  F-moniker cousin
source_url: https://www.tomshardware.com/pc-components/cpus/amd-reportedly-prepping-ryzen-5-7500-non-f-cpu-with-integrated-graphics-at-double-the-price-six-core-zen-4-chip-rumored-to-share-identical-specs-with-its-f-moniker-cousin
source_site: Tom's Hardware
source_slug: toms-hardware
scraped_at: '2026-09-05T15:05:52Z'
...
AMD Ryzen 5 7500 (no F, no X3D, no nothing) incoming. AM5 socket 3,7 GHz, up to 5,0 GHz boost 6C/12T 38MB cache in total 65W TDP ~230 Euro
...
- 
Reply
 Future pricing will make it relevant or irrelevant.COLGeek said:Seems like an okay choice for a basic "office-type" or web browser OEM PC, but I don't really see a great deal of appeal for the aftermarket.
 
This could easily become a successor to the Ryzen 5 5500, which is the #2 best selling CPU on Amazon right now. But in the US that CPU sells for $85, not over $200, and DDR4 is obviously much cheaper.
