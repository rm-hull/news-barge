---
title: Nvidia returns to selling Founder's Edition RTX 50-series GPUs at MSRP in person
  at PAX West — Verified Priority Access has RTX 5090, RTX 5080, and RTX 5070 at list
  price
source_url: https://www.tomshardware.com/pc-components/gpus/nvidia-returns-to-selling-founders-edition-rtx-50-series-gpus-at-msrp-in-person-at-pax-west-verified-priority-access-has-rtx-5090-rtx-5080-and-rtx-5070-at-list-price
source_site: Tom's Hardware
source_slug: toms-hardware
scraped_at: '2026-09-05T18:12:29Z'
...
- 
Reply
Nvidia leak the dlss5 dll to the public so that the modding community could make it publicly acceptable. Moddiing community already has support for Radeon hardware faster than I typed this. Nvidia no not like that we are still trying to work on finishing 5000 series before we move on to 4000 series. 🤪thisisaname said:It iis looking like DLSS 5 is not as dead to me as I was thinking 🤯 :giggle:
- 
Reply
 Loving the modding community for showing them the tech does not need to be restricted to the latest generation of cards.aberkae said:Nvidia leak the dlss5 dll to the public so that the modding community could make it publicly acceptable. Moddiing community already has support for Radeon hardware faster than I typed this. Nvidia no not like that we are still trying to work on finishing 5000 series before we move on to 4000 series. 🤪
Will be interesting to see what AMD does next :)
