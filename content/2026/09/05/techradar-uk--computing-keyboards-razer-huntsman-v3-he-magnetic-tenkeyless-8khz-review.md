---
title: '“I haven’t experienced many analog switches better than this”: Razer’s new
  magnetic keyboard is a dream to game with — but it needs one more thing to make
  it great for typing'
source_url: https://www.techradar.com/computing/keyboards/razer-huntsman-v3-he-magnetic-tenkeyless-8khz-review
source_site: TechRadar UK
source_slug: techradar-uk
scraped_at: '2026-09-05T04:17:24Z'
...
Razer’s magnetic Huntsman nails analog switches in a way very few others have. They feel as tactile as mechanical ones, yet offer all the customizations and performance tweaks you could wish for. The superlative design is yet another string to its bow. Its value is somewhat called into question given its lack of wireless support, but if you’re only interested in top-draw analog performance, the V3 HE is hard to beat.

#### Pros

- +Fantastic build quality
- +Bright backlighting
- +Tactile and adjustable analog switches

#### Cons

- -Thick keycaps for typing
- -No wrist rest included
- -Cheaper, better-value alternatives available
...
It looks like a high-performing machine. The all-black colorway might be a little drab, but the floating keycaps and subtly brushed metal faceplate add touches of class. The bright RGB backlighting also helps to sell its gaming prowess.
 ...
 ![three-quarter view of Razer Huntsman V3 HE Magnetic Tenkeyless 8KHz on desk with pink wall in background](https://cdn.mos.cms.futurecdn.net/xJcMLsDG3NHDRoiXFzsPDi.jpg) 
...
This is perhaps the major drawback of the V3 HE, along with its price, which is quite high for a keyboard lacking wireless connectivity. However, its gaming performance and build quality are to be admired, and might just make it worth the outlay.
 ...
 ![Close-up of navigation keys on Razer Huntsman V3 HE Magnetic Tenkeyless 8KHz on desk](https://cdn.mos.cms.futurecdn.net/DXHv8qDQNrj5TchiHcACQo.jpg) 
...
| Layout | TKL | 
| Switch | Analog (Razer Hall Effect Magnetic) | 
| Programmable keys | Yes | 
| Dimensions | 14.2 x 5.5 x 1.6 inches (361 x 139 x 40mm) | 
| RGB or backlighting | Yes (customizable) | 

 ![Close-up of arrow keys on Razer Huntsman V3 HE Magnetic Tenkeyless 8KHz on desk](https://cdn.mos.cms.futurecdn.net/EhSv5oafiUdsU5AS2zaxX6.jpg) 
...
Another nice touch is the recessed USB port. This encloses the jack completely, adding security and creating a neater look. The included cable should prove long enough to accommodate most setups, and what’s more it’s braided, which is more common on the best gaming mice. This improves flexibility, although it’s thicker and seems more durable than those on said mice.
 ...
 ![Close-up of escape key on Razer Huntsman V3 HE Magnetic Tenkeyless 8KHz, on desk with pink wall in background](https://cdn.mos.cms.futurecdn.net/y3z7C5dUwLKMxSTKLjND3B.jpg) 
...
I was glad to see the inclusion of a visualizer that shows the travel of your presses in real time by filling up a bar. This bar is also marked with your currently set actuation point in millimeters, so you can see when you’ve passed it. It’s a shame there’s no visualizer for the Rapid Trigger function, given this can be a little tricky to comprehend. For the most part, though, Synapse is clearly laid out and easy to use.
 ...
 ![Close-up of top row of keys on Razer Huntsman V3 HE Magnetic Tenkeyless 8KHz with F5 keycap removed, on a desk with pink wall in background](https://cdn.mos.cms.futurecdn.net/vF2PyPnePeN8GZQBJjvyLK.jpg) 
...
| Value | Cheaper than some other premium analog keyboards, but a lot more expensive than others, too. | 3.5 / 5 | 
| Design and features | The Huntsman looks sleek and is built incredibly well. It’s a shame there’s no wrist rest, though. | 4.5 / 5 | 
| Performance | The analog switches are tactile and very customizable, but the tall keycaps make typing a chore. | 4 / 5 | 
| Overall | The Huntsman V3 HE is a fantastic gaming keyboard with analog switches that perform as well as you could wish for. It would seriously benefit from a wrist rest, and it’s expensive compared to some others in the space, but its performance and build are matched by very few. | 4 / 5 | 

## Buy it if…

**You want great analog performance**

I haven’t experienced many analog switches better than these, and their copious adjustments should please every gamer out there.

**You prize build quality**

The sleek floating keycaps are attractive, while the super solid yet super light and compact design is a marvel.

## Don't buy it if…

**You’ll be typing alot**

I found the keycaps too tall to type comfortably with for long periods.

**You want the best value**

The V3 HE is expensive, especially when you consider its wired-only connectivity and TKL layout.

## Razer Huntsman V3 HE Magnetic Tenkeyless 8KHz review: Also consider

**SteelSeries Apex Pro TKL Gen 3**

Another high-performing analog keyboard, the Apex Pro also has the build quality to match the Huntsman’s. It’s more expensive, but it does at least come with a wrist rest, although it’s not the best example. Read our full SteelSeries Apex Pro TKL Gen 3 review.

**MonsGeek FUN60 Ultra**

If you’re looking to spend a lot less on an analog keyboard, look no further than the FUN60 Ultra. Not only is it surprisingly high performing, but it’s also seriously well made. And to cap it all off, it has multiple wireless connectivity modes. Read our full MonsGeek FUN60 Ultra review. 

 ![Three-quarter view of right-hand portion of Razer Huntsman V3 HE Magnetic Tenkeyless 8KHz, on a desk with pink wall in background](https://cdn.mos.cms.futurecdn.net/HcagZDgvWuCmYiXcvmZHuU.jpg) 
