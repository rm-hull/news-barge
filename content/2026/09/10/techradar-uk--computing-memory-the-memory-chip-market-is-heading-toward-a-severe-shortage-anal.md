---
title: Analyst talks of 'historic shortage' of RAM as AI boom ramps up, a signal that
  2027 could be dire — but at least there's a glimmer of good news from Framework
source_url: https://www.techradar.com/computing/memory/the-memory-chip-market-is-heading-toward-a-severe-shortage-analyst-firm-believes-ram-crisis-could-get-far-worse-in-2027-and-you-can-blame-ai-ramping-up
...
- **A new report from KB Securities gets very gloomy about the RAM crisis**
...
This has caused concerns that available memory supplies could dwindle and be depleted in 2027, with analysts believing that the "memory chip market is heading toward a severe supply shortage" (again, bear in mind this is a translation, but the message is clear enough).
...
This means that some of its current Framework Laptop orders will be knocked down in price, and the company said on X that it's "retroactively reducing prices for orders that shipped at higher price" too.

## Analysis: there's a historic level of gloom, that much is certain

 ![Hand holding two DDR5 RAM memory modules in front of gaming computer with RGB lighting](https://cdn.mos.cms.futurecdn.net/6yum7WNr4CeWzqyEs4abR3.jpg) 
