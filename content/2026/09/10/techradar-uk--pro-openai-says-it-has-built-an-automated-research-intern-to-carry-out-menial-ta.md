---
title: OpenAI says it has built an 'automated research intern' to carry out menial
  tasks — and it's only just getting started
source_url: https://www.techradar.com/pro/openai-says-it-has-built-an-automated-research-intern-to-carry-out-menial-tasks-and-its-only-just-getting-started
source_site: TechRadar UK
source_slug: techradar-uk
scraped_at: '2026-09-10T22:31:04Z'
...
- **OpenAI is developing a tool that can perform “well-defined research tasks”**
