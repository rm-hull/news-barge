---
title: Developer uses Claude to vibe code a Windows 3.1 shell in an hour — reanimated
  12MB retro launcher runs on both Windows 11 and Apple Silicon
source_url: https://www.tomshardware.com/software/windows/developer-uses-claude-to-vibe-code-a-windows-3-1-shell-in-an-hour-reanimated-12mb-retro-launcher-runs-on-both-windows-11-and-apple-silicon
...
If you are yearning for a quick-shot retro Windows experience on your modern Windows 11 or macOS system, then there’s a new vibe-coded clone of the Windows 3.1 Program Manager that may interest you. Developer Mayuki has released a neat little nostalgia project dubbed ReProgman – named after the ancient Windows 3.1 ‘progman.exe ’, which was the primary shell of the era – until Windows 95 swept it away three decades ago.
 ...
 ![ReProgman macOS screenshot](https://cdn.mos.cms.futurecdn.net/wxvaUCYjdb6KBJrbPEEbTR.jpg) 
...
- 
I remember up to Windows XP I could change the registry to make Progman.exe the default UI from a Windows recovery environment boot CD. Handy trick if virus or malware had destroyed Windows ability to boot due usually to corruption and hijacking of Windows explorer. Then you still had a GUI from which to launch anti-virus tools or things like Malwarebytes and clean the computer enough to re-install Internet Explorer before re-enabling the original UI again. But XP also had the ability to run a repair install as well.Reply
...
- 
Oh, for the sake of Pete!! "Vibe Code" has entered the computer Science universe and someone forgot to tell us what that meant!! I had to Google it....Reply
