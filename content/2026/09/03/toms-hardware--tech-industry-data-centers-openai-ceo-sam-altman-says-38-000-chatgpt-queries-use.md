---
title: OpenAI CEO Sam Altman says 38,000 ChatGPT queries use as much water as the
  production of one almond — says data centers use no more water than an office building
source_url: https://www.tomshardware.com/tech-industry/data-centers/openai-ceo-sam-altman-says-38-000-chatgpt-queries-use-as-much-water-as-the-production-of-one-almond-says-data-centers-use-no-more-water-than-an-office-building
...
![Sam Altman on OpenAI’s next model and the AI backlash - YouTube](https://img.youtube.com/vi/VeizK1M7V7E/maxresdefault.jpg) 
...
- 
ReplyScott_Tx said:Just a general rule you shouldn't believe anything he says.
 Even then we use to much water for almonds so why not reduce water for both.
 
It like saying "I only kill 1 person a month while others kill more so what I do is ok". OK lets get rid of both of you.
- 
"Let them eat almonds"Reply
 -Sam Altman- probably
 
I can eat an almond Sam. I cant eat 38000 GPT queries. In fact, if Ai data centers are perfectly fine, I propose that Sam Altman build one in his back yard and live there for a year. Lead by example
- 
38k inquiries is just over a second of the estimated ChatGPT inquiries in any given day (104 million is the estimated number). Putting it into quantifiable terms is better than just blindly throwing numbers out... unless your aim isReply *trying* to use subterfuge to obscure your intentions!
- 
Reply
 Straw man argument equating water use to killing people.Marlin1975 said:Even then we use to much water for almonds so why not reduce water for both.
 
It like saying "I only kill 1 person a month while others kill more so what I do is ok". OK lets get rid of both of you.
- 
Reply
 Eat that almond and then spend all day doing that task ChatGPT could do in 20 minutes.btmedic04 said:"Let them eat almonds"
 -Sam Altman- probably
 
 I can eat an almond Sam. I cant eat 38000 GPT queries. In fact, if Ai data centers are perfectly fine, I propose that Sam Altman build one in his back yard and live there for a year. Lead by example
 
People who don't use AI have no idea how valuable it is for those who do.
- 
Reply
By "he" I assume you mean the author, who presents two cases where CONSTRUCTION impacted water supply and calls it "datacenter use" ?Scott_Tx said:Just a general rule you shouldn't believe anything he says.
- 
Reply
 If you are going to extrapolate that, can't assume only one California almond is eaten in the same periodgcoleman99 said:38k inquiries is just over a second of the estimated ChatGPT inquiries in any given day (104 million is the estimated number). Putting it into quantifiable terms is better than just blindly throwing numbers out... unless your aim is *trying* to use subterfuge to obscure your intentions!
 
 CA almond farming has been under attack for some time because of excessive water use.
 
 Datacenters, even old ones using evap cooling still use less water than golf courses.
 
The water use claims are wildly overblown and thats true whether you love or hate AI
