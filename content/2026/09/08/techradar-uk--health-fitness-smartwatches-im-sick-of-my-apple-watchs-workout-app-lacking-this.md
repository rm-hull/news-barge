---
title: This rumored Apple Watch Ultra 4 and Series 12 feature could solve the biggest
  problem I have when working out with my Apple Watch — and it might be arriving tomorrow
source_url: https://www.techradar.com/health-fitness/smartwatches/im-sick-of-my-apple-watchs-workout-app-lacking-this-key-fitness-feature-but-a-new-apple-watch-ultra-4-rumor-suggests-it-could-finally-catch-up-with-apps-like-smartgym
...
- **A new leak has shed light on a rumored new watchOS 27 feature**
...
“The new implementation can describe individual sets and store repetition counts, weight, equipment, body side, and duration for each set,” the leaker added. “A workout activity can now represent a session with multiple sets, with different loads and repetition counts in each.”
...
## It’s about time
 ...
 ![Three Apple Watches on a blue background showing the SmartGym app](https://cdn.mos.cms.futurecdn.net/KNmyTjhdGt27bqbGVQSewM.jpg) 
