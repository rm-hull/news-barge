---
title: Microsoft engineer claims 'typing code is absolutely over', with AI and GitHub
  Copilot set to transform coding as we know it
source_url: https://www.techradar.com/pro/microsoft-engineer-claims-typing-code-is-absolutely-over-with-ai-and-github-copilot-set-to-transform-coding-as-we-know-it
...
- **Microsoft dev claims the age of typing code is coming to an end**
...
## Developers aren't obsolete, but their role is undergoing major changes
...
While models will undoubtedly get better as generations progress, mistakes will likely remain a constant throughout, so while Fowler's claim that typing code is over, the role of the human developer certainly isn't.
