---
title: UK government rejects calls for AI ‘kill switch’ amid growing fears of its
  risks
source_url: https://www.independent.co.uk/news/uk/politics/kill-switch-ai-government-burnham-b3048927.html
...
On Friday, the Cabinet Office voiced its resistance to establishing a new "last-resort power" that would permit the state to shut down an autonomous model during an emergency, stating the UK "cannot simply turn AI off".

The position follows efforts by peers in Parliament in recent weeks to argue for such a safeguard amid escalating alarms over technological risks, including warnings from experts that the technology could wipe out humanity within the decade.

Earlier in September, Liberal Democrat Lord Clement-Jones submitted an amendment to the Cyber Security and Resilience Bill creating a legal mechanism for state intervention should a model malfunction.

He said this would allow for "a necessary emergency kill switch" in situations where the Government "currently lack clear statutory power to direct an emergency shutdown".
...
![Peers have sought to make the case for a “kill switch” in Parliament in recent weeks](https://static.independent.co.uk/2026/09/11/14/5c6aaf707240fd9a1362df77e761d1bfY29udGVudHNlYXJjaGFwaSwxNzg5MjEzMDY5-2.85621626.jpg)
