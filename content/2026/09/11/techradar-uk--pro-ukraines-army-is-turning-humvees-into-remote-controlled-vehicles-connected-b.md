---
title: Ukraine's army is turning Humvees into remote-controlled vehicles connected
  by Starlink
source_url: https://www.techradar.com/pro/ukraines-army-is-turning-humvees-into-remote-controlled-vehicles-connected-by-starlink
...
- **Ukrainian firm Drone Fight Group has delivered three Humvees fitted with its Kaban remote-control kit**
...
## What does Kaban offer the Ukrainian military?
...
If the on-device GPS is jammed or spoofed, which is a routine occurrence near the line of contact, the operator can correct the vehicle's position manually instead of losing it to attackers. If the link fails entirely, however, Kaban brings the vehicle to an automatic stop.
