---
title: Asus routers can now be sold in the US — but it's bad news for TP-Link
source_url: https://www.techradar.com/pro/asus-routers-can-now-be-sold-in-the-us-but-its-bad-news-for-tp-link
source_site: TechRadar UK
source_slug: techradar-uk
scraped_at: '2026-09-11T19:10:11Z'
...
- **Asus is the latest company to get sales approval across its consumer routers**
...
## FCC issues new permits for router sales

In a strike of good luck for Asus, the regulatory clearance also means that Asus should be able to launch its upcoming Wi-Fi 8 hardware.
...
In order to get Conditional Approval, TP-Link would need to prove things like corporate ownership, board members, IP ownership, router designs, firmware updates and more.
