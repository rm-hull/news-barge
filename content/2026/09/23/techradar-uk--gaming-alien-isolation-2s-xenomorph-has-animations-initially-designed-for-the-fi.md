---
title: 'The Xenomorph is ''more responsive, reactive, and terrifying'' in Alien: Isolation
  2, says Creative Assembly, as it improved legacy animations that were too advanced
  for the first game — ''The vision was there, but they didn''t have the technology
  at the time'''
source_url: https://www.techradar.com/gaming/alien-isolation-2s-xenomorph-has-animations-initially-designed-for-the-first-game-but-the-team-didnt-have-the-technology-at-the-time-to-use-them-but-now-the-alien-is-even-more-responsive-and-reactive
source_site: TechRadar UK
source_slug: techradar-uk
scraped_at: '2026-09-23T22:06:03Z'
published: '2026-09-23T00:00:00Z'
description: 'Alien: Isolation 2 uses Xenomorph legacy animations the studio designed
  for the first game but didn''t have the technology to implement at the time.'
categories:
- Technology & Software
- Arts & Culture
- Video Gaming
...
* ***Alien: Isolation 2* principal environment artist Archie Whitehead says the Xenomorph uses legacy animations that Creative Assembly designed for the first game**
...
"Intelligence is about perception," Whitehead said. "It's about what the player sees. If the alien was a cube sliding around, it might still kill you; it might still be scary, but you probably wouldn't perceive it as that intelligent if it was just a rotating cube, right?
...
"I was studying when the original came out, so I wasn't on the first game," he said. "So, I was coming to this as a big fan, and I was chatting to him, and he was showing me these legacy animations he had, and I was like, 'I played the original a lot of times, I don't recognize these animations.'
