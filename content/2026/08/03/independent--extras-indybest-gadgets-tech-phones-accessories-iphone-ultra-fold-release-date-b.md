...
source_url: https://www.independent.co.uk/extras/indybest/gadgets-tech/phones-accessories/iphone-ultra-fold-release-date-b3026555.html
source_site: The Independent
source_slug: independent
scraped_at: '2026-08-03T15:11:38Z'
...
It’s been a long time coming, but Apple may finally be ready to lift the lid on its first foldable iPhone. Reportedly in development for years, the iPhone Ultra would see Apple enter the foldable market for the first time, with the handset potentially sporting similar dimensions to the recently launched Samsung Galaxy Z Fold 8.

While there's been lots of conflicting information over whether the iPhone Ultra will be delayed due to manufacturing issues, there's a good chance we'll at least see the foldable phone unveiled next September, even if it doesn't actually launch then.

Below, we’re rounding up everything we know so far about the iPhone Ultra, from its expected price and release date to the latest design, camera and display rumours.
