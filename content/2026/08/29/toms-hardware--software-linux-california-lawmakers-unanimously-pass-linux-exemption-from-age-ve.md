...
title: California lawmakers unanimously pass Linux exemption from age-verification
  law — software distributed under the GPL, MIT, BSD, and Apache licenses are exempt
source_url: https://www.tomshardware.com/software/linux/california-lawmakers-unanimously-pass-linux-exemption-from-age-verification-law-software-distributed-under-the-gpl-mit-bsd-and-apache-licenses-are-exempt
...
[https://agelesslinux.org/index.html](https://agelesslinux.org/index.html)
- 
Reply
...
- 
Reply
 For most layman, I agree. We may still see an increase move to FOSS platforms for the non-layman that are still using the Windows and/or Mac platforms. We shall see either way.USAFRet said:My thought is that any age verification thing in Windows or macOS will be so innocuous as to pass right by.
People won't notice it happening. Or care.
- 
