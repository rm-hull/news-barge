---
title: GTA 6 leaker cashes out in $250,000 crypto rug pull just hours before Rockstar's
  official reveal — memecoin crashes as Cyberleek's 'anti-corporate' campaign ends
  in a payday
source_url: https://www.tomshardware.com/video-games/console-gaming/gta-6-leaker-cyberleek-cashes-out-roughly-250000-hours-before-rockstars-official-reveal
source_site: Tom's Hardware
source_slug: toms-hardware
scraped_at: '2026-08-29T13:49:19Z'
...
The person or group behind nine days of Grand Theft Auto VI gameplay leaks cashed out of the $CYBERLEEK memecoin on Thursday, hours before Rockstar's Extended Look premiered on Netflix, according to on-chain data reported by CoinDesk. The wallet that created the Solana token claimed roughly $146,000 in wrapped SOL plus 15.4 million tokens in accumulated creator fees, then sold the whole allocation for about $125,000 in SOL in a single transaction, with GTAForums user *ViceCit* — who has been documenting the debacle — putting the total exit near $250,000 across four transactions.
...
- 
Fascinating stuff. People were voting on what to leak next with the cryptocurrency. So it's not like it was a surprise that the whole point was to transfer money to a criminal, and I don't know if I would call it a "rug pull".Reply
 
There's still the matter of possibly leaking the build, which could undermine the launch, especially if it works on PC, and also provide an inside look at the development history, depending on the age of the build.
