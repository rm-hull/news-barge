---
title: 'This week on Tom''s Hardware Premium: August 22, 2026 — foundries, supercomputers,
  China, and how to not overpay on a motherboard'
source_url: https://www.tomshardware.com/tech-industry/this-week-on-toms-hardware-premium-august-22-2026-foundries-supercomputers-china-and-how-to-not-overpay-on-a-motherboard
...
Within the article, Joe details exactly what you might want to pay for — and the things you don't need to focus on, like fancy 20+ phase MOSFET VRMs, or that slick RGB shroud, which pretty much just sits there looking pretty while other components do the real work. So if you're in the market for a new motherboard, or if you want to learn more about them in general, Joe's article is a fantastic, detailed read on exactly what you should be looking for, more important the reasons you shouldn't be splashing over $500 in the current market.
 ...
 ![El Capitan](https://cdn.mos.cms.futurecdn.net/S2jZYakwLVQq5DKi6a9HDb.jpg) 
...
The outlook for traditional supercomputers, which are benchmarked using the High Performance Linpack benchmark (HPL), remains mixed, as compute workloads continue to diversify amid shifting trends and demands, splintering the supercomputer race.
 ...
 ![Samsung](https://cdn.mos.cms.futurecdn.net/3pf6PE4Z2pa5PxEKw3B6uH.jpg) 
...
- ***H200 AI GPUs finally reach China under case-by-case import licenses, but it's already too late for Nvidia***
- ***China's homegrown AI accelerators to supply 90% of the country's domestic market, analysts suggest***
...
![Tom's Hardware Premium Subcription Tom's Hardware Premium Subcription](https://cdn.mos.cms.futurecdn.net/RZiWuzR4HNRoJJYAbkWDRX-200-80.png.webp)
...
- 
Reply
 At the very least, they've given an outlet to talk about these premium articles. There is no "premium forum" with threads for each article, since AFAIK they don't have a way to link forum accounts to subscribers.LordVile said:How about I don’t overpay for a premium subscription instead?
 
 Speaking of optical components, which are one of the hottest commodities in the chipmaking industry, the market is set to explode, estimated to reach an eye-watering $144.4 billion by 2030. Driving those figures, according to China Insights Consultancy, is a hunger for co-packaged optics, photonics chips, transceiver modules, and new techniques, as copper traces and cables begin to reach their natural bandwidth limits. This could be one of the better side benefits of the current situation, huge investment in optical technologies.
- 
Reply
 I mean I’d rather then not charge a ridiculous amount for access to sensationalist articles that still have ads.usertests said:At the very least, they've given an outlet to talk about these premium articles. There is no "premium forum" with threads for each article, since AFAIK they don't have a way to link forum accounts to subscribers.
 
 
This could be one of the better side benefits of the current situation, huge investment in optical technologies.
