---
title: China's top DRAM maker CXMT sues Pentagon over its blacklisting — argues chips
  are standard civilian JEDEC spec, not defense hardware
source_url: https://www.tomshardware.com/pc-components/dram/chinas-top-dram-maker-cxmt-sues-pentagon-over-its-blacklisting-argues-chips-are-standard-civilian-jedec-spec-not-defense-hardware
...
- 
The real problem from the US perspective if you could tear the chip apart and prove it's fine today, but next month's batch may not be, and you're not going to inspect chips in every batch... So not worth the risk, just like China not wanting to use Windows or Nvidia.Reply
