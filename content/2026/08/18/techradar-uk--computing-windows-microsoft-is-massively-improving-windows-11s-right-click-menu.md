---
title: '''They had 5 years to do that'': Microsoft is finally banishing the bloat
  from Windows 11''s right-click menu'
source_url: https://www.techradar.com/computing/windows/microsoft-is-massively-improving-windows-11s-right-click-menu-but-it-should-have-been-like-this-from-the-start
...
Firstly, the right-click menu is a lot less cluttered, with far fewer options now appearing in the list by default (building on some previous work along these lines). On top of that, there's new functionality in Windows 11's settings, enabling you to customize what appears in the context menu.
...
## Analysis: it's about time
 ...
 ![Windows 11 context menu redesign shown in test build in August 2026](https://cdn.mos.cms.futurecdn.net/kRhN9tEukwM3p4xAZgsb5F.jpg) 
