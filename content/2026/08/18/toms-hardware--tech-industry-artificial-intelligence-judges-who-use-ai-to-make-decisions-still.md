---
title: Judge allegedly outsourced entire ruling to AI and still can't be sued — federal
  court upholds blanket judicial immunity
source_url: https://www.tomshardware.com/tech-industry/artificial-intelligence/judges-who-use-ai-to-make-decisions-still-protected-by-judicial-immunity-court-ruling-protects-outcomes-regardless-of-ai-usage
source_site: Tom's Hardware
source_slug: toms-hardware
scraped_at: '2026-08-18T13:03:39Z'
...
- 
ReplyInterestingly, the ruling does not determine whether the judge actually used AI or whether such use is legally allowed, reports Reason. This is a neat judicial trick that applies to "qualified immunity" more generally.
 
If a court rules that a defendant is protected by immunity, and then dismisses the case without ruling on whether the conduct was otherwise legal, then it avoids setting a precedent that could be used to override qualified immunity in the future.
