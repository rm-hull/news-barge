---
title: I retook a GCSE maths test 11 years later to see whether my A* grade was a
  fluke
source_url: https://www.thenorthernecho.co.uk/news/national/uk-today/25393011.retook-gcse-maths-test-10-years---fared/?ref=rss
source_site: The Northern Echo
source_slug: northern-echo
scraped_at: '2026-08-20T08:53:17Z'
...
image: https://www.thenorthernecho.co.uk/resources/images/19835616.jpg?type=og-image
---

*(Image: Newsquest)*

With A Level results in the bag and GCSE results here once again, I thought I'd turn back the years and put my old knowledge to the test.

I decided to test just how much GCSE maths I remember by retaking a past paper.

Since I took my GCSEs, the grading system has changed, going from A* - G to 9 - 1, in 2017.

With this, (at least I think anyway), the tests have gotten harder.

  The grade changes took place in 2017 

*(Image: Newsquest)*

Not to brag or anything, but I did get an A* in my GCSE maths exam, but can this be replicated more than 10 years later with no revision?
...
Edexcel was my exam board back in the day; God, doesn't that make me sound old, but this meant that I went with the same one when choosing a past paper.

You can find an array of past papers online, which is useful for current students revising ahead of their own exams.
...
Easy enough, work out the difference between each number, which in this case is 4, and then figure out the difference between that number and the first in the sequence, which is -3.
  ...
  Question 1 and my workings out 

*(Image: Newsquest)*

4n - 3 is the answer, and we're feeling good.
...
From working out the sector of a circle in pi and rationalising denominators, to volume and more complex algebraic equations, I was struggling.
  ...
  An algebra question I could not answer 

*(Image: Newsquest)*

And I'm not afraid to admit it, from question 14 to 23, which was the final one, you could count the marks I achieved on one hand...
...
- Could you pass your GCSEs if you sat them now? Prove it with our quiz
- Do teachers know GCSE results before students receive them?

But that was not the only thing I came away with from this experience, with the last third of the paper giving me nothing but a headache.

So it is something I don't plan on repeating anytime soon...

For all of you getting your GCSE results this week, good luck!

  *How do you think you would fare if you re-sat your GCSEs? Let us know in the comments.*
