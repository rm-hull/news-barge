---
title: Physical media nostalgia sees fundraisers flock to Blu-Ray Kickstarter — drive
  with 9-in-1 dock achieves 160x funding goal halfway through campaign
source_url: https://www.tomshardware.com/peripherals/docking-stations-hubs/physical-media-nostalgia-sees-fundraisers-flock-to-blu-ray-kickstarter-drive-with-9-in-1-dock-achieves-160x-funding-goal-halfway-through-campaign
...
| BluHub specifications |  | 
|---|---|
| **Optical Drive** | Blu‑ray / DVD / CD read & write, 6x Blu‑ray burning speed | 
| **Disc Handling** | Standard disc tray plus ‘piano‑lid’ spare disc holder | 
| **USB Ports** | 4× USB‑A (USB 3.0) | 
| **Card Readers** | SD and microSD slots, read speeds 160 MB/s+ | 
| **Host Connectivity** | Dual connectors: USB‑A and USB‑C | 
| **Data Rate (Host Link)** | USB 3.2 Gen 2, up to 10 Gbps | 
| **Power** | USB bus‑powered (no external PSU required) | 
| **Compatibility** | Windows, macOS, Linux, Chrome OS, and mobile OTG | 
| **Chassis Material** | Aluminum | 
| **Dimensions** | 165 x 160 x 34mm (6.5 x 6.3 x 1.34-inches) | 
| **Weight** | 409g (14.4oz) | 
...
![BluHub portable Blu-ray hub](https://cdn.mos.cms.futurecdn.net/rHcyr8j4J8njUjqyEEPCVU-680-80.jpg) 

![BluHub portable Blu-ray hub](https://cdn.mos.cms.futurecdn.net/bb2Pm3s6ys3HQWF2UUoSRU-680-80.jpg) 

![BluHub portable Blu-ray hub](https://cdn.mos.cms.futurecdn.net/eWjhMK6wqV2r4JjinYjsSU-680-80.jpg) 

![BluHub portable Blu-ray hub](https://cdn.mos.cms.futurecdn.net/vSQkatadopR5H6tV5UmBUU-680-80.jpg) 
...
- 
So, basically a low cost, no-name Blu-ray drive with a card reader and USB hub built in, from a company with zero track record and all the uncertainty of a Kickstarter. In other words, even more to go wrong due to selection of subpar components and zero guarantee of delivery.Reply
 
Why take the risk when there are plenty of drives we already know work from existing companies?
- 
Yeah this is jumping on a bandwagon, the PR photos make it look like its some kind of standalone unit which it isn't, its not a CD, DVD or Blu-ray player its just a regular PC optical drive which very few people use a PC for these days.Reply
 
Those lamenting the decline of physical media players are talking about fully self contained players not PC's.
- 
As much as I love the idea of this, there are some major red flags:Reply
 - The funding goal is incredibly low: this means the goal will always be met and all the backers will be charged whether it actually goes ahead or not. And as these are pledges, there's no guarantee anything will be shipped
- They're planning to get all kickstarter shipments fulfilled in Nov 2026 after it closes in Sept 2026. And yet they can't confirm the specifics of the drive they use in these
