---
title: Hit your Claude limit? This free extension lets you take the conversation to
  ChatGPT or Gemini and keep going
source_url: https://www.techradar.com/ai-platforms-assistants/claude-hit-me-with-a-usage-limit-so-i-moved-the-entire-conversation-to-chatgpt-this-free-browser-extension-made-it-ridiculously-easy
source_site: TechRadar UK
source_slug: techradar-uk
scraped_at: '2026-08-20T13:06:51Z'
published: '2026-08-20T00:00:00Z'
description: ThreadPort moves active conversations between all three AI assistants
...
![ThreadPort](https://cdn.mos.cms.futurecdn.net/Jkquo6dYLP2HPssE3yUdda.gif)
...
The process worked the same when sending to Claude from ChatGPT. ThreadPort supports all six directions among ChatGPT, Claude, and Gemini. But, as an additional test, I took the extended conversation from Gemini and asked ThreadPort to send it to Claude. The new Claude tab was basically the same, but it also mentioned in the opening prompt that it was a conversation "started on ChatGPT (via ChatGPT → Gemini)," and tagged which chatbot was responding in the transcript.
 ...
 ![ThreadPort](https://cdn.mos.cms.futurecdn.net/uJKPg4W4w9o3ftdQixA2HZ.png) 
...
## Smooth moves
 ...
 ![ThreadPort](https://cdn.mos.cms.futurecdn.net/yV3UcNfJKf9tDxeKcJd8PZ.png) 
