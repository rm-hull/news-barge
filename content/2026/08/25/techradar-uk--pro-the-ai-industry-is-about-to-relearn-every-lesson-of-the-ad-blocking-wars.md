---
title: The AI industry is about to relearn every lesson of the ad blocking wars
source_url: https://www.techradar.com/pro/the-ai-industry-is-about-to-relearn-every-lesson-of-the-ad-blocking-wars
...
Maybe money does not explain everything, but it explains a lot. Goldman Sachs estimates the AI build-out will require roughly $7.6 trillion in capital over the next five years across compute, data centers and power. It’s unlikely that subscriptions alone will cover the bill, which is why ads are coming to AI.
...
Leads communications for Adblock Plus and AdBlock at eyeo.
