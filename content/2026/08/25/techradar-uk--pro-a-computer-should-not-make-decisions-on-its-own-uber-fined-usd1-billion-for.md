---
title: '''A computer should not make decisions on its own'': Uber fined $1 billion
  for using automated systems to suspend 171 drivers'
source_url: https://www.techradar.com/pro/a-computer-should-not-make-decisions-on-its-own-uber-fined-usd1-billion-for-using-automated-systems-to-suspend-171-drivers
source_site: TechRadar UK
source_slug: techradar-uk
scraped_at: '2026-08-25T16:50:45Z'
...
- **Dutch investigation and French complaint accuse Uber of banning drivers via algorithms**
...
## Uber hit with €825 million GDPR fine
...
Uber argues that fraud-related suspensions were generally short-lived, and that permanent account deactivations were not made without human review, thus it intends to appeal. "We strongly disagree with this decision and disproportionate fine," the company said in a statement (via *Reuters*).
