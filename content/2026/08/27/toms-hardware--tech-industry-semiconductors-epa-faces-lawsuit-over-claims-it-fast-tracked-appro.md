---
title: EPA faces lawsuit over claims it fast-tracked approval of toxic 'data center
  chemicals' — exposure to photoacid generators used for semiconductor manufacturing
  could result in ‘sudden death,’ also appear to be long-lasting PFAS
source_url: https://www.tomshardware.com/tech-industry/semiconductors/epa-faces-lawsuit-over-claims-it-fast-tracked-approval-of-toxic-data-center-chemicals-exposure-to-photoacid-generators-used-for-semiconductor-manufacturing-could-result-in-sudden-death-also-appear-to-be-long-lasting-pfas
source_site: Tom's Hardware
source_slug: toms-hardware
scraped_at: '2026-08-27T22:14:25Z'
published: '2026-08-27T00:00:00Z'
description: These chemicals are crucial for semiconductor manufacturing, but they
...
- 
I think what gets me most about all the seeming fast tracking is that environmental rules and regulations have done a good job regarding silicon manufacturing. A large amount of the existing chemicals are recycled and while developing those systems was expensive ends up being a win for the companies in the long term. While I have no interest in stopping manufacturing or advancement we've proven it can be done while being mindful of potentially harmful consequences.Reply
 
Nobody should be afraid of a standardized review process unless they have something to hide. If a review process is genuinely onerous then it should be fixed not thrown out.
