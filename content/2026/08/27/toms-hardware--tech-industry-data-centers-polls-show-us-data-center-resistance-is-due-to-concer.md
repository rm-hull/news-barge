---
title: Polls reveal local utility hikes and noise drive US data center protests, not
  anti-AI sentiment— beliefs and political affiliation had minimal impact on AI data
  center views
source_url: https://www.tomshardware.com/tech-industry/data-centers/polls-show-us-data-center-resistance-is-due-to-concerns-over-object-level-local-environmental-impact-beliefs-and-political-affiliation-had-minimal-impact-on-ai-data-center-views
...
- 
That makes sense. Higher energy costs and noise isn't something people enjoy. Also causes a heat island where the AI data center is and increases climate change due to the increase of resources required to run them and more pollution.Reply
- 
Higher energy costs indicate a failure at the level of state law and the public utilities commission. "Significant" additions to the utility load should be forced to carry the marginal cost of the added power and NOT receive any benefit from existing sources of low cost power . -- grandad .Reply
- 
If China can hack most of our government for years and basically get away with it they can easily influence our media, social media, and activist groups. We're far more vulnerable to outside influence than we're willing to believe and some naive article citing polls that by their very language often skew the polls negatively towards AI data centers is far from proof of anything other than polling is easily manipulated.Reply
 
 We're most certainly being influenced, the motivation is absolutely going to be designed to slow our AI progress, and the only question is how effective and widespread that influence is. It's extremely easy to spread any narrative you want on the internet and can be done very cheaply, especially in the context of the kind of money being invested in AI combined with the importance being placed on it by governments.
 
 Ultimately it's unlikely to be very effective as projects will just change locations if they have to and the real bottleneck will likely be other things like availability of skilled labor to build the data centers or fab contracts that can produce enough of the technology needed to even fire up the data centers to the scale envisioned.
 
AI is so quickly becoming a can't live without tool it simply makes no sense to stop developing and advancing it. If it's not literally in your back yard and guaranteed to cause you real long term problems and just moving isn't an option then opposition to data centers is probably just stupid.
