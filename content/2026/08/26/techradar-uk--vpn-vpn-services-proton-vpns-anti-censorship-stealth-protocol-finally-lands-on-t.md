---
title: Proton VPN’s anti-censorship Stealth protocol finally lands on the stable Linux
  release
source_url: https://www.techradar.com/vpn/vpn-services/proton-vpns-anti-censorship-stealth-protocol-finally-lands-on-the-stable-linux-release
source_site: TechRadar UK
source_slug: techradar-uk
scraped_at: '2026-08-26T13:11:41Z'
published: '2026-08-26T00:00:00Z'
description: The censorship-bypassing tool has officially moved to the main branch,
  making it easier than ever for Linux users to beat online restrictions
...
- **Proton VPN’s Stealth protocol has graduated to a stable release on Linux**
...
## Proton VPN Linux's updates recap

This stable release is just the latest in a rapid-fire series of updates for the open-source operating system. Earlier this year, Proton VPN revealed a major Linux makeover for both GUI and CLI users, bringing the Linux client much closer to feature parity with its Windows and Mac counterparts.
