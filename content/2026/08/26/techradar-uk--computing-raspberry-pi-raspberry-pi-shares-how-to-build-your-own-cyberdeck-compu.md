---
title: This portable 'cyberdeck' computer is my next Raspberry Pi project — and the
  weatherproof build only costs $250 despite the RAM crisis
source_url: https://www.techradar.com/computing/raspberry-pi/raspberry-pi-shares-how-to-build-your-own-cyberdeck-computer-inside-a-waterproof-briefcase-and-itll-only-cost-you-usd250
source_site: TechRadar UK
source_slug: techradar-uk
scraped_at: '2026-08-26T16:56:34Z'
...
- **A comprehensive new Raspberry Pi tutorial has appeared**
...
To the Raspberry Pi 5, case, and keyboard you also need to attach several other peripherals — including a display, so you can see what you're doing. The finished creation has a built-in power supply too, so you're ready for off-grid life.

## Parts and pricing

 ![Raspberry Pi cyberdeck](https://cdn.mos.cms.futurecdn.net/UZgddqZyVAnxbo4U5iFvnn.jpg) 
