---
title: AI server boom funds $314 universal cash payout in Taiwan — President Lai Ching-te
  says the payout ensures the country's AI windfall 'can be shared by all,' 11% GDP
  growth and $903B export surge finance $7.4B dividend
source_url: https://www.tomshardware.com/tech-industry/taiwan-to-pay-every-resident-314-from-its-ai-boom-windfall
...
Taiwan will send NT$10,000 (roughly $314 USD) in cash to every resident next year, President Lai Ching-te said Monday. The 2027 central government budget sets aside NT$235.7 billion ($7.4 billion USD) so that, in his words, the "AI dividend can be shared by all."
