---
title: When private traffic ban on major York route to boost buses could start
...
THE month when a trial ban on private traffic driving through a major York route has been revealed along with new details on how the scheme will work.
...
- Verdict on private car ban through major York city centre route to improve buses
- Activist's legal threat over York traffic restrictions - as council 'listening'
...
Warnings would be given for breaking the rules for the trial’s first six months with fines handed out afterwards, though repeat offenders in the initial half year would receive penalties.
  ...
  A map showing how the proposed Rougier Route in York would work and changes since the scheme was first unveiled 
